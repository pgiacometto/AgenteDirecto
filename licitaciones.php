          ...
          <div class="page-aside-inner" data-plugin="pageAsideScroll">
            <div data-role="container">
              <div data-role="content">
                ...
                <!--section class="page-aside-section">
                  <h5 class="page-aside-title">Activar filtros</h5>
                  <div class="list-group">
                    <a class="list-group-item" href="javascript:void(0)"><i class="icon md-image" aria-hidden="true"></i>Mas Recientes</a>
                  </div>
                </section-->
              </div>
            </div>
            ...
            <li>
              <div class="media-item" data-toggle="slidePanel" data-url="panel-licitaciones.tpl">
                ...
                <div class="info-wrap">
                        ...
                        <div class="time">Tiempo: (hace 10 mins)</div>
                        <div class="time">Rank: 12</div>
                        <div class="time">Número de Cotizaciones Recibidas: 12</div>
                </div>
              </div>
            </li>
